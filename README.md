...
### Выполнение 1
Что я делал:
1. Запускаю ВМ и создаю две директории для запуска двух серверов на Python
2. Установил `haproxy` 
3. Запустил два python-сервера с разными портами. Один с портом `8888` ,а второй `9999`
